...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { date: @workout.date, description: @workout.description, summary: @workout.summary }
    end
  ...
  test "should update workout" do
    put :update, id: @workout, workout: { date: @workout.date, description: @workout.description, summary: @workout.summary }
    assert_redirected_to workout_path(assigns(:workout))
  end
